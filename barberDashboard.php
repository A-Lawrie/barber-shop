        ...
        <div id="sidebar-wrapper">
			<div class="side-top">
				...
				<ul class="sidebar-nav">
					...
					<li><a class="active" href="barbers.html">Our Barbers</a></li>
        ...
        <div id="page-content-wrapper">
            ...
            <div id="barbers" class="section lb">
                <div class="container-fluid">
                    <iframe src="https://calendar.google.com/calendar/embed?height=800&wkst=1&ctz=Africa%2FNairobi&showPrint=0&title=Sm-Barber%20Appointments&mode=MONTH&src=bGF3cnkub2NoaWVuZ0BzdHJhdGhtb3JlLmVkdQ&src=ZW4ua2UjaG9saWRheUBncm91cC52LmNhbGVuZGFyLmdvb2dsZS5jb20&color=%23039BE5&color=%230B8043" style="border:solid 1px #777" width="1200" height="700" frameborder="0" scrolling="no"></iframe>
                </div><!-- end container -->
            </div><!-- end section -->
